...
More about the `FeedItems` component in the docs: [gatsby-theme-chronoblog#feeditems-component](https://github.com/Ganevru/gatsby-theme-chronoblog#feeditems-component)
...
More about the additional site pages in the docs: [gatsby-theme-chronoblog#pages](https://github.com/Ganevru/gatsby-theme-chronoblog#pages)
