...
Or make a contribution to the [Chronoblog repository](https://github.com/Ganevru/gatsby-theme-chronoblog) with a link to your site - in README in the section "sites using Chronoblog".
...
There you can ask your questions, make suggestions, etc.
